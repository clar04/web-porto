  ...
  const dataProjects = [
    {
      ...
      description: "Dikembangkan sistem rekomendasi properti real-time untuk Melbourne. Fitur termasuk dashboard interaktif menggunakan Python untuk menganalisis tren penjualan dan perilaku pelanggan. Integrasi Kafka dan MinIO untuk streaming dan penyimpanan data, semua dideploy via Docker.",
    ...
    },
    {
      ...
      description: "Mengimplementasikan klasifikasi emosi untuk ulasan pelanggan menggunakan berbagai model deep learning. Tujuan proyek ini adalah memproses dan menganalisis data tekstual untuk mengkategorikan emosi, membantu pemahaman sentimen pelanggan.",
    ...
    },
    {
      ...
      description: "Membangun pipeline machine learning untuk mengklasifikasikan publikasi teks biomedis ke dalam jenis kanker spesifik. Proyek ini memanfaatkan Apache Spark (PySpark) untuk pemrosesan data skala besar serta teknik NLP dan model TensorFlow.",
  ...
  const webProjects = [
    {
      ...
      description: "My personal portfolio website, designed and built from scratch using React and Tailwind CSS. Showcases my projects and skills with a clean, modern, and responsive design.",
    ...
    },
    {
      ...
      "description": "A React-based web application for employee management, featuring user authentication, profile editing, and a responsive design with theme switching. It includes features like user authentication, employee CRUD operations, search, pagination, profile editing, and dark/light theme switching.",
      "tech": ["React", "React Router DOM", "Tailwind CSS", "Vite", "PostCSS", "Autoprefixer", "ESLint"],
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 font-sans text-white">
      ...
      <nav className="fixed top-0 w-full bg-black/40 backdrop-blur-md z-50 border-b border-white/10 shadow-lg">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <h1 className="text-3xl font-extrabold text-white tracking-wide">Clara's Profile</h1>
          <div className="hidden md:flex space-x-6">
            {[
              { id: 'about', label: 'About Me', icon: <User className="w-5 h-5" /> },
              { id: 'web-projects', label: 'Web Projects', icon: <Globe className="w-5 h-5" /> },
              { id: 'data-projects', label: 'Data Projects', icon: <Database className="w-5 h-5" /> },
              { id: 'cv', label: 'My CV', icon: <FileText className="w-5 h-5" /> },
      ...
      {/* Hero/About Section */}
      <section id="about" className="min-h-screen flex items-center justify-center pt-24 pb-16 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-2xl text-gray-300 mb-12 max-w-3xl mx-auto">
            A passionate <span className="font-semibold text-purple-300">Data Enthusiast</span> and aspiring <span className="font-semibold text-pink-300">Web Developer</span>,
          ...
          <div className="max-w-4xl mx-auto bg-white/5 backdrop-blur-lg rounded-3xl p-10 border border-white/15 shadow-xl">
            ...
            <p className="text-lg text-gray-300 leading-relaxed mb-8">
              I'm a data enthusiast passionate about turning raw data into actionable insights, and I also find great joy in crafting engaging web experiences. Proficient in Python, SQL, and Excel, I navigate the full data lifecycle from cleaning and analysis to visualization and reporting. Simultaneously, I'm honing my skills in web development using modern frameworks like React and Next.js, building interactive and responsive applications. My goal is to combine analytical thinking with practical development to solve problems and create compelling digital stories, whether through data-driven dashboards or user-centric web applications.
            </p>

{/* Data Skills */}
<div className="mb-10">
  <h4 className="text-2xl font-bold text-white mb-4">Data Skills</h4>
...
{/* Web Skills */}
<div>
  <h4 className="text-2xl font-bold text-white mb-4">Web Dev Skills</h4>
  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
    {webSkills.map((skill, index) => (
      ...
      <section id="web-projects" className="py-20 bg-black/30 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Web Development Projects</h2>
            <p className="text-xl text-gray-300">Showcasing my work in building interactive and responsive web applications</p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            {webProjects.map((project, index) => (
              <div key={index} className="group bg-white/10 backdrop-blur-lg rounded-2xl overflow-hidden border border-white/15 hover:border-purple-500 transition-all duration-500 hover:shadow-2xl hover:translate-y-[-5px]">
      ...
      <section id="data-projects" className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Data Projects</h2>
            <p className="text-xl text-gray-300">Dive into my data analysis and machine learning endeavors</p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            {dataProjects.map((project, index) => (
              <div key={index} className="group bg-white/10 backdrop-blur-lg rounded-2xl overflow-hidden border border-white/15 hover:border-pink-500 transition-all duration-500 hover:shadow-2xl hover:translate-y-[-5px]">
                <div className="relative overflow-hidden">
                  <img
                    src={project.image}
                    alt={project.title}
      ...
      <section id="cv" className="py-20 bg-black/30 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-white mb-6">My Curriculum Vitae</h2>
          <p className="text-xl text-gray-300 mb-10">Access my professional CV for detailed qualifications and experience.</p>

          <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-10 border border-white/15 shadow-xl flex flex-col items-center">
            <h3 className="text-3xl font-semibold text-white mb-5">Download My CV</h3>
            <p className="text-lg text-gray-300 leading-relaxed mb-8">
              Click the button below to view or download my latest curriculum vitae in PDF format.
              This document provides a comprehensive overview of my education, technical skills, academic projects, and leadership roles.
            </p>
            <a
      ...
      <section id="contact" className="py-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="w-full bg-white/5 backdrop-blur-lg rounded-3xl p-10 border border-white/15 shadow-xl">
            <h3 className="text-3xl font-semibold text-white mb-10 text-center">Contact Information</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-white font-medium text-lg break-words group-hover:text-purple-300 transition-colors">claravalentina004@gmail.com</p>
                </div>
              </a>
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-white font-medium text-lg break-words group-hover:text-purple-300 transition-colors">linkedin.com/in/claravalentina004</p>
                </div>
              </a>
      ...
      <footer className="bg-black/50 backdrop-blur-md border-t border-white/10 py-8">
        <div className="max-w-7xl mx-auto px-6 text-center text-gray-400">
          <p className="mb-2">
            © 2025 Clara's Profile. All rights reserved.
          </p>
          <p>
            Built with <span className="text-purple-400">React</span> & <span className="text-blue-400">Tailwind CSS</span>
          </p>
        </div>
      </footer>
    </div>
